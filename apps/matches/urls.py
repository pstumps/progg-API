...
urlpatterns = [
    ...
    path('<int:dl_match_id>/user_details/', views.user_match_details, name='user_match_details'),
    path('<int:dl_match_id>/user_details/<int:user_id>', views.user_match_details, name='user_match_details'),
]
